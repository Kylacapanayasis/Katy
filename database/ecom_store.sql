...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_email`, `customer_pass`, `customer_city`, `customer_contact`, `customer_address`, `customer_image`, `verification_code`, `email_verified_at`, `status`) VALUES
(1, 'Christian Mendoza', 'chan@gmail.com', '123', 'Manila', '09569321078', 'Pasigxd', '48046637_2149093078735525_2122338508562497536_n.jpg', NULL, NULL, 'disapproved'),
(2, 'jer', 'jeriannamae@gmail.com', 'jer', 'Laguna', '343242342423', '2312733313', 'matthew-hamilton-qKpEYgWKogU-unsplash.jpg', NULL, NULL, 'approved'),
(11, 'bossing', 'customer2@gmail.com', '123', 'Laguna', '123', '123', 'persona.png', 268230, '2024-11-08 23:11:14', 'approved'),
(17, 'boss', 'customer1@gmail.com', '123', 'Laguna', '123', '123', 'kkbb.jpg', NULL, NULL, 'pending');
...
(105, 29, 1, 645, 16109368, 2, '', 'Regular', 'Fine Grind', '2024-11-10', 'ToShip', 'Cash on Delivery'),
(106, 30, 1, 1005, 527993935, 3, '', 'Regular', 'Medium Grind', '2024-11-10', 'pending', 'online'),
(107, 29, 1, 345, 454389417, 1, '', 'Regular', 'Medium Grind', '2024-11-10', 'pending', 'online');
...
INSERT INTO `payments` (`payment_id`, `invoice_no`, `amount`, `due_amount`, `payment_mode`, `ref_no`, `payment_date`, `proof`, `payment_status`) VALUES
(13, 454389417, 0, 345, 'online', '', '2024-11-10', 'proofs/kkbb.jpg', 'pending');
...
CREATE TABLE `products` (
  ...
  `product_lifespan` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `products` (`product_id`, `p_cat_id`, `cat_id`, `manufacturer_id`, `expiry_date`, `product_title`, `product_url`, `product_img1`, `product_img2`, `product_img3`, `product_price`, `product_keywords`, `product_desc`, `product_label`, `product_sale`, `product_quan`, `product_status`, `product_lifespan`) VALUES
...
--
ALTER TABLE `customer_orders`
  MODIFY `order_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `payments`
--
ALTER TABLE `payments`
  MODIFY `payment_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
