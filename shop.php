...
?>
   ...
   <?php 
    ...
    ?> 
           ...
           <div class="center"><!-- col-md-9 Begin -->

                <div class='box'style="visibility: hidden;"><!-- box Begin -->
                    
                    <h1><i class="fa fa-shopping-cart"></i> Shop</h1>
               ...
               <center>
                   <ul class="pagination" style="visibility: hidden;"><!-- pagination Begin -->
