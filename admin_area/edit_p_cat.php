...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from product_classifications where p_cat_id='$edit_p_cat_id'";
    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Edit Product Classification
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-pencil fa-fw"></i> Edit Product Classification
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if(is_uploaded_file($_FILES['p_cat_image']['tmp_name'])){
                ...
                $update_p_cat = "update product_classifications set p_cat_title='$p_cat_title',p_cat_image='$p_cat_image' where p_cat_id='$p_cat_id'";
                ...
                $update_p_cat = "update product_classifications set p_cat_title='$p_cat_title',p_cat_top='$p_cat_top' where p_cat_id='$p_cat_id'";
