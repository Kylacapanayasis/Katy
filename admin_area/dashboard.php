                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                    <?php 
                                        ...
                                        // $get_title = "select * from products where product_id='$product_id'";
                                                                            
                                        // $run_title = mysqli_query($con,$get_title);

                                        // $row_title = mysqli_fetch_array($run_title);

                                        // $product_title = $row_title['product_title'];
                                ...
                                <td>
                                    ...
                                    }elseif($order_status =='Waiting for approval'){

                                        echo $order_status='To be reviewed by admin';
